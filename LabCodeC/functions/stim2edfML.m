...
global Visual;
    ...
    P1 = strsplit(sentenceString, '\n\n');
    P1 = char(P1(1));
    P2 = strsplit(sentenceString, '\n\n');
    P2 = char(P2(2));
    
    sentenceString= strsplit(P1, '\n');
    ...
    %% P2
    sentenceString= strsplit(P2, '\n');
    sentenceString(cellfun('isempty', sentenceString))= [];
    
    %char_count= 0;
    x_start= [];
    x_end= [];
    y_start= y_start+ (linespan+1)*2;
    y_end= y_end+ (linespan+1)*2;
    %y_start= Visual.offsetY- Visual.LetterHeight;
    %y_end= Visual.offsetY+ Visual.LetterHeight + Visual.LetterHeight* (Visual.TextSpacing)/2 -1;
    %linespan= y_end- y_start;
